...
{
    public class PendingUserResponse : BaseResponse
    {
        public override void Fill(BaseRequest request)
        {
            ...
            try
            {
                var req = (request as MusicEventAPI.Models.Request.PendingUserRequests);


                using (SqlConnection con = new SqlConnection(DBConnection.MusicEventConnectionString))
                {
                    SqlCommand com = new SqlCommand("PendingUserRequestList", con);
