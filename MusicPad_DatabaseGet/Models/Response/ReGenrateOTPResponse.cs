...
{
    public class ReGenrateOTPResponse : BaseResponse
    {
        public override void Fill(BaseRequest request)
        {
            ...
            try
            {
                var req = (request as MusicEventAPI.Models.Request.ReGenrateOTPRequest);
                ...
                {
                    SqlCommand com = new SqlCommand("ReGenrateOTP", con);
